...
const CartItem = ({item}) => {
  ...
  const {productid, title, price, image01, quantity, totalPrice} = item
      ...
      <div className="cart__item-info d-flex gap-2">
        ...
        <div className="cart__product-info d-flex w-100 align-items-center justify-content-between">
            <div>
                ...
                <p className='d-flex align-items-center gap-4 cart__product-price'>{quantity}x <span>Rs. {totalPrice}</span></p>
                <div className='d-flex align-items-center justify-content-between gap-4 increase__decrease-btn'>
